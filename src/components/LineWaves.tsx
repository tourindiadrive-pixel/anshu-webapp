...
const LineWaves = React.memo(function LineWaves({
  speed = 0.3,
  innerLineCount = 32.0,
  outerLineCount = 36.0,
  warpIntensity = 1.0,
  ...
  useEffect(() => {
    ...
    // Detect if the user device supports touch interactions/is a mobile/tablet
    const isTouchDevice = 
    ...
    const activeMouseInteraction = enableMouseInteraction && !isTouchDevice;
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uEnableMouse: { value: activeMouseInteraction }
      }
    });
    ...
    if (activeMouseInteraction && gl.canvas) {
